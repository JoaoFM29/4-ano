...
class CropWorker:
    ...
    def on_request(self, ch, method, properties, body):
        self.pool.apply_async(CropWorker.worker_handle_request, (ch, method, properties, body))
    ...
    def worker_handle_request(ch, method, properties, body):
        ...
        ch.connection.add_callback_threadsafe(
            functools.partial(CropWorker.publish_response, ch, properties, response))

        ch.connection.add_callback_threadsafe(
            functools.partial(CropWorker.ack_message, ch, method.delivery_tag))
